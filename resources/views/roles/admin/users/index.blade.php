    ...
    >
      @foreach ($users as $user)
        ...
        <td class="px-4 py-3 text-xs">
            ...
            @if ($user->is_admin == 1)
                <span
              class="flex justify-center px-2 py-1 font-semibold text-center leading-tight text-light bg-green-600 rounded-full">Admin</span>
            @else
                <span
              class="flex justify-center px-2 py-1 font-semibold text-center leading-tight text-light bg-blue-600 rounded-full">User</span>
            @endif
        </td>
        <td class="px-4 py-3 text-sm text-center">
