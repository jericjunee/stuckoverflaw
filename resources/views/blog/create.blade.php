...
@section('content')
    <section class="flex flex-col gap-5 px-36 py-24">
      <h1 class="text-6xl mb-20 text-center">Create new post</h1>
        ...
        <form class="flex flex-col gap-10 font-body" action="/blog" method="POST" enctype="multipart/form-data">
          @csrf
          <input class="font-heading text-5xl font-bold !outline-none" type="text" name="title" id="title" placeholder="Write your post title..">
          <div class="flex flex-row items-center gap-5">
            <label class="text-lg font-heading font-medium" for="category">Choose a category: </label>
          ...
          <div class="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600 text-lg">
            ...
            <div class="py-2 px-4 bg-white rounded-b-lg dark:bg-gray-800">
                <textarea id="body" name="body" rows="8" class="block px-0 w-full text-gray-800 bg-white dark:bg-gray-800 dark:text-white dark:placeholder-gray-400 !outline-none border-none focus:outline-none focus:border-none" placeholder="Start writing your post..." required></textarea>
            </div>
        </div>

        
        <div>
          <label class="block mb-2 text-xl font-heading font-medium text-gray-900 dark:text-gray-300" for="image">Upload cover photo</label>
